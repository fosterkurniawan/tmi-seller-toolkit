...
Verifikasi: 14 tes Node lulus. Lima nomor × empat format diuji, termasuk nomor pendek dari daftar. Nomor lain, perubahan satu digit, tambahan digit, karakter asing, nilai kosong dan penanda lama ditolak. Browser menunjukkan error ID/EN/ZH untuk nomor tak terdaftar; nomor terdaftar format +62 dengan spasi berhasil membuka home.
