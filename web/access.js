(function(){
  ...
  const keys=['fullName','phone','email','accessConsent'];
  ...
  ['fullName','phone','email'].forEach((id,index)=>field(id).addEventListener('keydown',e=>{if(e.key==='Enter'&&!e.isComposing){e.preventDefault();show(id);localizeUI();if(!validation(id))field(keys[index+1]).focus();}}));
